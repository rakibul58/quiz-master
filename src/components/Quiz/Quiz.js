    ...
    return (
        <div className='rounded-lg shadow-lg shadow-green-200'>
           ...
           <div className='text-center py-4 px-2'>
                ...
                <Link to={`/quiz/${id}`}><button className='bg-green-500 flex gap-2 mx-auto w-full py-2 rounded-lg text-white font-sans font-semibold items-center place-content-center'>Start Practice <ArrowRightIcon className='w-6 h-6' /></button> </Link>
           </div>
        </div>
    );
};
