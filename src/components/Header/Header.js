...
const Header = () => {
    return (
        <div className='header w-full mt-12 flex flex-col lg:flex-row items-center bg-green-500 rounded-lg pb-12 lg:pb-0'>
            <img className='w-fit lg:w-3/5 rounded-t-lg rounded-l-lg' src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1172&q=80" alt="" />
            <div className='pl-10 mt-4 ld:mt-0'>
